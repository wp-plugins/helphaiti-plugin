=== HelpHaiti Plugin ===
Contributors: cd_bernal
Donate link: http://www.divagando.com.es/
...
This plugin displays a image of a candle in remember of the Haiti victims in one square of your Wordpress blog.
You can select in the settings the square in which you want to show the candle. The default position is right bottom.
In my website http://www.divagando.com.es there is a "candle counter" to know how many blogs have their lighted candle.
...
If experience problems with the position of the banner, then you need to upgrade it.
...
1. Look at the right bottom of the screenshot.
...
* Fixed some problems with activation and deactivation functions, doing it more reliable.

* Fixed some problems with image position.

Español

* Arreglados algunos problemas con las funciones de activacion y desactivacion, haciendolas mas estables.
